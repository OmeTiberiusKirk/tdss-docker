    ...
    <DIV class="section bordered">
      ...
      <DIV class=tutorials_list><!-- InstanceBeginEditable name="visualization_output" -->
        <div style="background-color:#D5EBFD; padding:4px 4px 4px 4px; border-top:#999999 1px solid"><strong>Operations&nbsp;:&nbsp;</strong>
          ...
          <a href="search.php?section=4"><font color="#000099">Create new </font></a> | <a href="bulletin_release.php?section=<?=$_REQUEST['section']?>"><font color="#000099">List of released bulletin</font></a> | <a href="<?=$_SERVER['PHP_SELF']?>?section=<?=$_REQUEST['section']?><?=strlen($_REQUEST['id']) > 0 ? "&id=".$_REQUEST['id'] : ""?>"><font color="#000099">Reload</font></a></div>
        <table width="10" height="2" border="0">
          <tr>
            <td></td>
          </tr>
        </table>
        <form action="bulletin_create_script.php?grp_id=<?=$_REQUEST['grp_id']?>" method="post">
                  ...
                  <tr bgcolor="#FFFFFF">
                    <td colspan="3" valign="top" bordercolor="#999999" bgcolor="#7B869A" ><div align="center" class="style31">
                        <div align="left">Bulletin information of <b><u>
                          ...
                          <input type="hidden" name="result_name" value="<?=$_REQUEST['name']?>">
                        </div>
                      </div></td>
                  </tr>
          ...
          <table width="443" border="0" cellpadding="4" cellspacing="0" id="search_tbl" style="display:" class="tbl_border">
            ...
            <tr onMouseOver="javascript: this.style.background='#D0EFFB';" onMouseOut="javascript: this.style.background='';">
              ...
              <th align="left" scope="col"><table width="0" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                  	<?php
						$eq_date = explode("/", $_REQUEST['date']);
						//print_r($eq_date);
						$eq_correct_date = $eq_date[1]."/".$eq_date[0]."/".$eq_date[2];
                    ?>
                    <td><input name="eq_date" id="eq_date" style="text-align:center" type="date" value="<?=$_REQUEST['date']?>" size="25" maxlength="25"></td>
                    <td></td>
                    <td>&nbsp;</td>
                    <td><input name="eq_time" id="eq_time" value="<?=$_REQUEST['time']?>" size="15" maxlength="15" style="text-align:center"></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                  </tr>
            ...
            <tr onMouseOver="javascript: this.style.background='#D0EFFB';" onMouseOut="javascript: this.style.background='';">
              ...
              <th align="left" scope="col"><table width="0" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><input name="eq_richter" id="eq_richter" style="text-align:center"  value="<?=$_REQUEST['magnitude']?>" size="25" maxlength="25"></td>
                    <td></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
            ...
            <tr onMouseOver="javascript: this.style.background='#D0EFFB';" onMouseOut="javascript: this.style.background='';">
              ...
              <th align="left" scope="col"><table width="0" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><input name="eq_depth" id="eq_depth" style="text-align:center" onClick="displayDatePicker('ADate');" value="<?=$_REQUEST['depth']?>" size="25" maxlength="25"></td>
                    <td></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
            ...
            <tr onMouseOver="javascript: this.style.background='#D0EFFB';" onMouseOut="javascript: this.style.background='';">
              ...
              <th scope="col" valign="middle"><img src="../../image/buttonorange.gif" alt="0" width="7" height="10"></th>
              <th align="left" valign="top" scope="col"><input name="eq_lat" id="eq_lat" style="text-align:center" value="<?=$_REQUEST['lat']?>" size="50" maxlength="50"></th>
            </tr>
            <tr onMouseOver="javascript: this.style.background='#D0EFFB';" onMouseOut="javascript: this.style.background='';">
              <th align="left" valign="middle" bgcolor="#F0F0F0" scope="col">&nbsp;&nbsp;&nbsp;+&nbsp;Longitude</th>
              <th scope="col" valign="middle"><img src="../../image/buttonorange.gif" alt="0" width="7" height="10"></th>
              <th align="left" valign="top" scope="col"><input name="eq_long" id="eq_long" style="text-align:center" value="<?=$_REQUEST['long']?>" size="50" maxlength="50"></th>
            </tr>
          </table>
          <table width="10" height="2" border="0">
            <tr>
...
$order = array_merge(range(2, 6), [1], range(7, 16), range(19, 21), [22, 24, 17, 18, 23], range(25, 30)); 

$data = [];
while ($row = mysql_fetch_object($res_point_eta)) {
    $data[] = $row;
}
...
foreach ($order as $index) {
    if (isset($data[$index - 1])) {
      ...
      $n = 1;
      foreach ($order as $index) {
        if (isset($val_zmax[$index - 1])) {
            $reordered_zmax[$n] = $val_zmax[$index - 1];
            $n++;
        }
    }

      $i = 1;
			foreach ($reordered_data as $obj) {
            ...
            <tr onMouseOver="javascript: this.style.background='#D0EFFB';" onMouseOut="javascript: this.style.background='';">
              ...
              <th align="left" scope="col" class="tbl_border_right"><div align="center">
                  <?php
										...
										$res_time = number_format($obj->values/3600, 3);
										//echo $res_time;
              ...
              <th align="left" scope="col"><div align="center">
                  <?=number_format($reordered_zmax[$i-1], 3)?>
                  <input type="hidden" name="ob[zmax][<?=$i?>]" value="<?=$reordered_zmax[$i-1]?>">
                </div></th>
            </tr>
            <?php
			}
