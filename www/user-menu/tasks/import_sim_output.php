...
<DIV id=main>
  ...
  <DIV id=middle_column>
    <DIV class="section bordered">
      <H2 id=icon_pick><img src="../../image/color_theory_small_icon.jpg" width="14" height="14">&nbsp;<!-- InstanceBeginEditable name="title_workspace" -->Simulation reference ID: <font color="#FFFF99"><?=$_SESSION['import'][1]['name']?></font>, group of <font color="#FFFF99"><?=$_SESSION['g_name']?></font> [Step 3 of 3]<!-- InstanceEndEditable --> </H2>
