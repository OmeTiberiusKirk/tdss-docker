<?php
	...
	class Bulletin {
		...
		public function Create() {
			...
			$txt_6 = $this->pdf->conv("วันที่     ".$date."              เวลา      ".date("H:i", time())."      น." );
			...
			$this->pdf->SetFont('AngsanaNew', '', 15);
			$txt_8 = $this->pdf->conv("         ศูนย์กลางที่  ละติจูด   ".round($this->eq_latitude, 2)."   องศาเหนือ    ลองจิจูด   ".round($this->eq_longitude, 2)."   องศาตะวันออก    บริเวณ   ".$this->eq_area."           ระยะห่าง    ".$this->eq_distance."    กิโลเมตร       จากชายฝั่ง ".$this->eq_coastname." ของไทย");
			$this->pdf->MultiCell(0, 7, $txt_8, 0, 'J');
			$this->pdf->Ln(5);
			...
			$this->pdf->Line(33, 194, 33, 202);
			$this->pdf->Line(53, 194, 53, 202);
			$this->pdf->Line(83, 194, 83, 202);
			$this->pdf->Line(141, 194, 141, 202);
			$this->pdf->Line(171, 194, 171, 202);
			
			$this->pdf->Line(33, 194, 171, 194);
			$this->pdf->Line(33, 202, 171, 202);
			...
			$xx = 38; $yy = 208;  $xx2 = 38; $yy2 = 45;
			$yy_column = 210; $yy2_col = 47;
			$yy_row = 210; $yy2_row = 47;
			/* page 3 */
			$xx3 = 38; $yy3 = 45;
			$yy3_col = 47;
			$yy3_row = 47;
			...
			foreach($this->ob_area as $index => $p_info) {
				...
				if($line < 10 ){	
					...
					$this->pdf->Text($xx+18 , $yy, $txt_16);
					$this->pdf->Text($xx+68 , $yy, $txt_17);
					$this->pdf->Text($xx+82 , $yy, $txt_17_1);
					$this->pdf->Text($xx+110 , $yy, $txt_18);
					$this->pdf->Text($xx+117 , $yy, $txt_18_1);
					/* table column */
					$this->pdf->Line(33, 194, 33, $yy_column);
					$this->pdf->Line(53, 194, 53, $yy_column);
					$this->pdf->Line(83, 194, 83, $yy_column);
					$this->pdf->Line(141, 194, 141, $yy_column);
					$this->pdf->Line(171, 194, 171, $yy_column);
					...
					if($check_page_2 == 1){
						...
						$check_page_2 = 0;
						/* create table */
						$this->pdf->Line(33, 31, 33, $yy2_col-8);
						$this->pdf->Line(53, 31, 53, $yy2_col-8);
						$this->pdf->Line(83, 31, 83, $yy2_col-8);
						$this->pdf->Line(141, 31, 141, $yy2_col-8);
						$this->pdf->Line(171, 31, 171, $yy2_col-8);
					...
					$this->pdf->Text($xx2+18 , $yy2, $txt_16);
					$this->pdf->Text($xx2+68 , $yy2, $txt_17);
					$this->pdf->Text($xx2+82 , $yy2, $txt_17_1);					
					$this->pdf->Text($xx2+110 , $yy2, $txt_18);
					$this->pdf->Text($xx2+117 , $yy2, $txt_18_1);
					/* create table */
					$this->pdf->Line(33, 31, 33, $yy2_col);
					$this->pdf->Line(53, 31, 53, $yy2_col);
					$this->pdf->Line(83, 31, 83, $yy2_col);
					$this->pdf->Line(141, 31, 141, $yy2_col);
					...
					if($check_page_3 == 1){
						...
						$check_page_3 = 0;
						/* create table */
						$this->pdf->Line(33, 31, 33, $yy3_col-8);
						$this->pdf->Line(53, 31, 53, $yy3_col-8);
						$this->pdf->Line(83, 31, 83, $yy3_col-8);
						$this->pdf->Line(141, 31, 141, $yy3_col-8);
						$this->pdf->Line(171, 31, 171, $yy3_col-8);
					...
					$this->pdf->Text($xx3+18 , $yy3, $txt_16);
					$this->pdf->Text($xx3+68 , $yy3, $txt_17);
					$this->pdf->Text($xx3+82 , $yy3, $txt_17_1);
					$this->pdf->Text($xx3+110 , $yy3, $txt_18);
					$this->pdf->Text($xx3+117 , $yy3, $txt_18_1);
					/* create table */
					$this->pdf->Line(33, 31, 33, $yy3_col);
					$this->pdf->Line(53, 31, 53, $yy3_col);
					$this->pdf->Line(83, 31, 83, $yy3_col);
					$this->pdf->Line(141, 31, 141, $yy3_col);
