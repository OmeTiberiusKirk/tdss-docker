<?php
	...
	class Bulletin {
		...
		public function Create() {
			...
			$this->pdf->SetFont('AngsanaNew', '', 15);
			$txt_8 = $this->pdf->conv("         ศูนย์กลางที่  ละติจูด   ".round($this->eq_latitude, 2)."   องศาเหนือ    ลองจิจูด   ".round($this->eq_longitude, 2)."   องศาตะวันออก   ");
			$this->pdf->MultiCell(0, 7, $txt_8, 0, 'J');
			$this->pdf->Ln(5);
			...
			$this->pdf->Line(33, 187, 33, 195);
			$this->pdf->Line(53, 187, 53, 195);
			$this->pdf->Line(83, 187, 83, 195);
			$this->pdf->Line(141, 187, 141, 195);
			$this->pdf->Line(171, 187, 171, 195);
			...
			foreach($this->ob_area as $index => $p_info) {
				...
				$pointStr_eta_unit = "น.";
				$pointStr_zmax = number_format($p_info['zmax_value'], 2);
				...
				if($line < 10 ){	
					...
					$this->pdf->Line(53, 187, 53, $yy_column);
					$this->pdf->Line(83, 187, 83, $yy_column);
					$this->pdf->Line(141, 187, 141, $yy_column);
					...
					$this->pdf->Text($xx2+63 , $yy2, $txt_17);
					...
					$this->pdf->Text($xx3+63 , $yy3, $txt_17);
