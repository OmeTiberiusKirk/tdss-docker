...
<script language="javascript">
	...
	function enable_map(lat, long) {
		...
		document.getElementById('res').src = 'http://www.ndwc.go.th/server_monitoring/map.php?lat='+lat+'&long='+long+'&zoom=2&info=Location';
	}
    ...
    <DIV class="section bordered">
      ...
      <DIV class=tutorials_list><!-- InstanceBeginEditable name="visualization_output" -->
        ...
        <div style="background-color:#D5EBFD; padding:4px 4px 4px 4px; border-top:#999999 1px solid"><strong>Operations :&nbsp; </strong><font color="#000099"> Select group</font>
		  ...
		  ?>
            <option value="0">! ERROR, no group</option>
            <?php
          }
		  ?>
          </select>
          | <a href="javascript: void(0)" onClick="javascript: smw_data()"><font color="#000099">Analyzed Data from Seismic Watch</font></a> | <a href="<?=$_SERVER['PHP_SELF']?>?section=4"><font color="#000099">Reload</font></a> <br>
        ...
        <div style="background-color:#FFC; padding:2px 2px 2px 2px; border-left:#F00 1px solid; border-right:#F00 1px solid; text-align:center; font-size:18px; color:#F00; text-decoration:">System is now maintenance !</div>
        <fieldset id="def" style="background-image:url(../../image/gradient-inner.png); background-repeat:repeat-x; display:">
          <legend><strong class="style37">Database summary (andaman sea, the gulf of thailand)</strong>&nbsp;</legend>
          <table border="0" cellpadding="4" cellspacing="0" id="search_tbl" style="display:; font-weight:normal">
            <tr>
              <td colspan="7" align="left" valign="middle" bgcolor="#F0F0F0" scope="col"><table width="10" height="2" border="0">
                <tr>
                  <td></td>
                </tr>
              </table></td>
            ...
            <tr>
              <td align="left" valign="middle" bgcolor="#F0F0F0" scope="col">&nbsp;</td>
              <td align="left" valign="middle" bgcolor="#F0F0F0" scope="col"><span style="font-weight: bold">Magnitude</span>
                <?php
                    $sql = "SELECT COUNT( * ) AS `Rows` , `magnitude` FROM `sim_result` GROUP BY `magnitude` ORDER BY `magnitude`";
					$rs1 = mysql_query($sql, $connection);
					?>
                </td>
                
              <td align="left" valign="middle" bgcolor="#F0F0F0" scope="col"><img src="../../image/buttonorange.gif" alt="0" width="7" height="10">
              <?php while($os1 = mysql_fetch_object($rs1)) { ?><td align="left" valign="top" bgcolor="white" scope="col" style="color:#900; border:1px solid #000">&nbsp;
                <?=$os1->magnitude?>
                &nbsp;</td>
              <td align="left" valign="top" bgcolor="#F0F0F0" scope="col" style="border-bottom:1px solid #000">&nbsp;
                <?php echo $os1->Rows; $mr += $os1->Rows; ?>
                &nbsp;</td>
              <?php } ?>              <td align="left" valign="top" bgcolor="#F0F0F0" scope="col" style="color: #900;">Total</td>
              <td align="left" valign="top" bgcolor="#F0F0F0" scope="col" style=""><?=$mr?></td>
            ...
            <tr>
              <td align="left" valign="middle" bgcolor="#F0F0F0" scope="col">&nbsp;</td>
              <td align="left" valign="middle" bgcolor="#F0F0F0" scope="col"><span style="font-weight: bold">Depth</span>                <?php
                    $sql = "SELECT COUNT( * ) AS `Rows` , `depth` FROM `sim_result` GROUP BY `depth` ORDER BY `depth`";
					$rs1 = mysql_query($sql, $connection);
					?></td>
              <td align="left" valign="middle" bgcolor="#F0F0F0" scope="col"><img src="../../image/buttonorange.gif" alt="0" width="7" height="10">
               <?php while($os1 = mysql_fetch_object($rs1)) { ?>
              <td align="left" valign="top" bgcolor="white" scope="col" style="color:#900; border:1px solid #000">&nbsp;
                <?=$os1->depth?>
              &nbsp;</td>
              <td align="left" valign="top" bgcolor="#F0F0F0" scope="col" style="border-bottom:1px solid #000">&nbsp;
                <?php echo $os1->Rows; $dr += $os1->Rows; ?>
              &nbsp;</td>
              
              <?php } ?>
              <td align="left" valign="top" bgcolor="#F0F0F0" scope="col" style="color: #900;">Total</td>
              <td align="left" valign="top" bgcolor="#F0F0F0" scope="col" style=""><?=$dr?></td>
            </tr>
            <tr>
              <td colspan="7" align="left" valign="middle" bgcolor="#F0F0F0" scope="col"><table width="10" height="2" border="0">
                <tr>
        ...
        <form action="<?=$_SERVER['PHP_SELF']?>?section=4&grp_id=<?=$_REQUEST['grp_id']?>" method="get" name="search">
          ...
          <fieldset id="def" style="background-image:url(../../image/gradient-inner.png); background-repeat:repeat-x; display:">
            ...
            <table border="0" cellpadding="4" cellspacing="0" id="search_tbl" style="display:">
              <tr>
                <th colspan="6" align="left" valign="middle" bgcolor="#F0F0F0" scope="col"><u>Search by</u> :</th>
              </tr>
              <!-- <tr>
              ...
              <tr>
                ...
                <th colspan="2" align="left" bgcolor="#F0F0F0" scope="col"><font color="#990000" style="font-weight:normal">
              ...
              <tr>
                ...
                <th scope="col" valign="middern"><img src="../../image/buttonorange.gif" alt="0" width="7" height="10"></th>
                <th align="left" scope="col"><input name="lat" type="text" style="width:100px; text-align:center; font-weight:bold" id="lat" value="<?=(float)$_SESSION['lat']?>"></th>
                <th align="left" scope="col"><font color="#990000" style="font-weight:normal">* For  searching with latitude and longitude, please set M and Δ to zero.</font></th>
              </tr>
              <tr>
                <th align="left" valign="middle" bgcolor="#F0F0F0" scope="col">&nbsp;</th>
                <th align="left" valign="middle" bgcolor="#F0F0F0" scope="col">&nbsp;</th>
                ...
                <th scope="col" valign="middern"><img src="../../image/buttonorange.gif" alt="0" width="7" height="10"></th>
                <th align="left" scope="col"><input name="long" type="text" style="width:100px; text-align:center; font-weight:bold" id="long" value="<?=(float)$_SESSION['long']?>"></th>
                <th align="left" scope="col" style="font-weight:normal">*&nbsp;<a href="javascript: void(0)" onClick="javascript: enable_map(document.getElementById('lat').value, document.getElementById('long').value);">See&nbsp;location</a></th>
              </tr>
              <!--<tr>
              <th align="left" valign="middle" bgcolor="#F0F0F0" scope="col">&nbsp;</th>
              <th align="left" valign="middle" bgcolor="#F0F0F0" scope="col">&nbsp;</th>
              ...
              <tr>
                ...
                <th scope="col" valign="middern"><img src="../../image/buttonorange.gif" alt="0" width="7" height="10"></th>
                <th align="left" scope="col"><input name="magnitude" type="text" id="magnitude" style="width:100px; text-align:center; font-weight:bold" value="<?=(float)$_SESSION['magnitude']?>"></th>
                <th align="left" scope="col">&nbsp;</th>
              </tr>
              <tr>
                <th align="left" valign="middle" bgcolor="#F0F0F0" scope="col">&nbsp;</th>
                ...
                <th scope="col" valign="middern"><img src="../../image/buttonorange.gif" alt="0" width="7" height="10"></th>
                <th align="left" scope="col"><input name="depth" type="text" id="depth" style="width:100px; text-align:center; font-weight:bold;" value="<?=(float)$_SESSION['depth']?>"></th>
                <th align="left" scope="col">&nbsp;</th>
              </tr>
              </tr>
              ...
              <tr <?php if($g != 0 || $page_start != 0) {?> onMouseOver="javascript: this.style.background='#D0EFFB'; this.style.borderBottom='#A4ED8B 1px solid'; this.style.borderTop='#A4ED8B 1px solid';  document.getElementById('s<?=$sim_result[$g]['id']?>').style.display='';" onMouseOut="javascript: this.style.background=''; this.style.borderBottom=''; this.style.borderTop=''; document.getElementById('s<?=$sim_result[$g]['id']?>').style.display='none';"<?php } ?> >
                <td><table border="0" cellpadding="0" cellspacing="1">
					...
					?>
                        ...
                        if($g==0 && $page_start == 0) {
						?>
                        <table width="85" height="80" border="0" cellpadding="0" cellspacing="0" background="../../image/image001.png" >
                          <tr>
                            <td height="18">&nbsp;</td>
                          </tr>
                          <tr>
                        ...
                        <table width="49" height="51" border="0" cellpadding="0" cellspacing="0" background="../../image/blog-calendar.png">
                          ...
                          <tr>
                            <td height="33"><div align="center"> Δ
                                <?=$sim_result[$g]['depth']?>
                              </div></td>
                          </tr>
                        </table>
				...
				?>
                  <div id="s<?=$sim_result[$g]['id']?>" style="display:<?=$display?>">
                    ...
                    <div align="right"><a onClick="javascript: create_bulletin(<?=$sim_result[$g]['id']?>, '<?=$sim_result[$g]['name']?>');" href="javascript: void(0);">Create&nbsp;Bulletin</a> | <a href="javascript: void(0)" onClick="javascript: enable_map(<?=$sim_result[$g]['decimal_lat']?>,<?=$sim_result[$g]['decimal_long']?>);">See&nbsp;location</a> | Reference ID =
                      <?=$sim_result[$g]['name']?>
        ...
        <div id="fade" class="black_overlay" onClick="javascript: document.getElementById('light').style.display='none'; document.getElementById('fade').style.display='none';"></div>
