...
<DIV id=header>
 ...
 and <a href="http://www.chula.ac.th" style="color:white" title="Chulalongkorn University" target="_blank">Chulalongkorn University</a></font></td>
            </tr>
          </table></td>
        <td>&nbsp;</td>
...
<DIV id=main>
  ...
  <DIV id=middle_column>
    <DIV class="section bordered">
      <H2 id=icon_pick><img src="../../image/color_theory_small_icon.jpg" width="14" height="14">&nbsp;<!-- InstanceBeginEditable name="title_workspace" -->Simulation reference ID: <font color="#FFFF99"><?=$_SESSION['import'][1]['name']?></font>, group of <font color="#FFFF99"><?=$_SESSION['g_name']?></font> [Step 2 of 3]<!-- InstanceEndEditable --> </H2>
