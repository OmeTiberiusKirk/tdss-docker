<?php
	...
	class Visualization {
		...
		public function createNetworkFile($url_ds_region, $url_ds_data, $tmp_filename, $zoom_t, $resolution_t, $rotate_x_t, $rotate_y_t, $rotate_z_t, $gridsize_x_t, $gridsize_y_t, $timestep_t, $region_t, $data_t, $axes_y_position, $axes_y_label, $axes_x_position, $axes_x_label, $point_name, $point_position, $contour_line, $contour_line2, $network_type, $reg_no) {
