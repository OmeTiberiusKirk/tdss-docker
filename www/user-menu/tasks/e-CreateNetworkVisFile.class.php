<?php
	...
	class BuildVisualizationNetwork {
		...
		public function __construct($network_file_type, $filename, $region_no, $display_type, $DX_region_filename, $DX_waterlevel_filename) {
		...
		private function run() {
			$this->VisObj = new Visualization($this->NetworkType, $this->NetworkDisplayType, $this->NetworkFilename, $this->RegionNo);
		}
		...
		public function BuildNetwork($zoom, $resolution, $rotate_x, $rotate_y, $rotate_z, $contour_line, $contour_line2, $network_type, $reg_no) {
