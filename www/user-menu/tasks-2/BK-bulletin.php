...
<?php
	...
	if(mysql_num_rows($res_point_eta) < 1) die("! I'm death.");
	
	$res_point_zmax = mysql_query($sql_zmax, $connection);
	if(mysql_num_rows($res_point_zmax) < 1) die("! I'm death.");
?>
<!-- InstanceEndEditable -->
  ...
  <DIV id=middle_column>
    <DIV class="section bordered">
      ...
      <DIV class=tutorials_list><!-- InstanceBeginEditable name="visualization_output" -->
        <div style="background-color:#D5EBFD; padding:4px 4px 4px 4px; border-top:#999999 1px solid"><strong>Related operations&nbsp;:&nbsp;</strong><a href="javascript: void(0)" onClick="javascript: alert('! Create bulletin from the result of simulation.'); document.location.href='result.php?section=3';"><font color="#000099">Create new </font></a> | <a href="bulletin_release.php?section=<?=$_REQUEST['section']?>"><font color="#000099">List of released bulletin</font></a> | <a href="<?=$_SERVER['PHP_SELF']?>?section=<?=$_REQUEST['section']?>"><font color="#000099">Reload</font></a></div>
        <table width="10" height="2" border="0">
          <tr>
            <td></td>
          </tr>
        </table>
        <form action="bulletin_create_script.php" method="post">
              ...
              <td valign="top"><table width="443" border="0" class="tbl_border" cellpadding="4" cellspacing="0" id="search_tbl3" style="display:">
                  <tr bgcolor="#FFFFFF">
                    <td colspan="3" valign="top" bordercolor="#999999" bgcolor="#7B869A" ><div align="center" class="style31">
                        <div align="left">Bulletin information</div>
                      </div></td>
                  </tr>
          ...
          <table width="443" border="0" cellpadding="4" cellspacing="0" id="search_tbl" style="display:" class="tbl_border">
            ...
            <tr onMouseOver="javascript: this.style.background='#D0EFFB';" onMouseOut="javascript: this.style.background='';">
              ...
              <th align="left" scope="col"><table width="0" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><input name="eq_richter" id="eq_richter" style="text-align:center" onClick="displayDatePicker('ADate');" value="<?=$obj_result->magnitude?>" size="25" maxlength="25"></td>
                    <td></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
            ...
            <tr onMouseOver="javascript: this.style.background='#D0EFFB';" onMouseOut="javascript: this.style.background='';">
              ...
              <th scope="col" valign="middle"><img src="../../image/buttonorange.gif" alt="0" width="7" height="10"></th>
              <th align="left" valign="top" scope="col"><input name="eq_lat" id="eq_lat" style="text-align:center" value="<?=($obj_result->lat_degree + ($obj_result->lat_lipda/60)+($obj_result->lat_philipda/3600))?>" size="50" maxlength="50"></th>
            </tr>
            <tr onMouseOver="javascript: this.style.background='#D0EFFB';" onMouseOut="javascript: this.style.background='';">
              <th align="left" valign="middle" bgcolor="#F0F0F0" scope="col">&nbsp;&nbsp;&nbsp;+&nbsp;Longitude</th>
              <th scope="col" valign="middle"><img src="../../image/buttonorange.gif" alt="0" width="7" height="10"></th>
              <th align="left" valign="top" scope="col"><input name="eq_long" id="eq_long" style="text-align:center" value="<?=($obj_result->long_degree + ($obj_result->long_lipda/60)+($obj_result->long_philipda/3600))?>" size="50" maxlength="50"></th>
            </tr>
            <tr onMouseOver="javascript: this.style.background='#D0EFFB';" onMouseOut="javascript: this.style.background='';">
              <th align="left" valign="middle" bgcolor="#F0F0F0" scope="col">Area</th>
              <th scope="col" valign="middle"><img src="../../image/buttonorange.gif" alt="0" width="7" height="10"></th>
              <th align="left" valign="top" scope="col"><table width="0" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><input name="eq_area" id="eq_area" style="text-align:center" value="(thailand)"  size="50" maxlength="50"></td>
                    <td></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
            ...
            <tr onMouseOver="javascript: this.style.background='#D0EFFB';" onMouseOut="javascript: this.style.background='';">
              <th align="left" valign="middle" bgcolor="#F0F0F0" scope="col">Distance&nbsp;from&nbsp;coast</th>
              <th scope="col" valign="middle"><img src="../../image/buttonorange.gif" alt="0" width="7" height="10"></th>
              <th align="left" valign="top" scope="col"><input name="eq_distance" id="eq_distance" style="text-align:center" value="0"  size="50" maxlength="50"></th>
            </tr>
            <tr onMouseOver="javascript: this.style.background='#D0EFFB';" onMouseOut="javascript: this.style.background='';">
              <th align="left" valign="middle" bgcolor="#F0F0F0" scope="col">Coast name</th>
              <th scope="col" valign="middle"><img src="../../image/buttonorange.gif" alt="0" width="7" height="10"></th>
              <th align="left" valign="top" scope="col"><input name="eq_coastname" id="eq_coastname" style="text-align:center" value="(coastline of thailand)"  size="50" maxlength="50"></th>
            </tr>
          </table>
          <table width="10" height="2" border="0">
            <tr>
          ...
          <table border="0" cellpadding="4" cellspacing="0" id="search_tbl2" style="display:" class="tbl_border">
            <tr bgcolor="#FFFFFF">
              <td colspan="6" valign="top" bordercolor="#999999" bgcolor="#7B869A"><div align="center" class="">
                  <div align="middle" class=""><font color="#FFFFFF" size="6">Information of observation area</font></div>
                </div></td>
            </tr>
            <tr>
              ...
              <th align="left" bgcolor="#BCCCDF" scope="col" class="tbl_border_right"><div align="center">Elapse Time Arrival&nbsp;(min)</div></th>
              <th align="left" bgcolor="#BCCCDF" scope="col"><div align="center">Wave Height&nbsp;(meter)</div></th>
            </tr>
            <?php
			$i = 1; $n = 1;
            ...
            <tr onMouseOver="javascript: this.style.background='#D0EFFB';" onMouseOut="javascript: this.style.background='';">
              ...
              <th align="left" scope="col" class="tbl_border_right"><div align="center">
                  <?=round(($obj->values), 0)?>
                  <input type="hidden" name="ob[eta][<?=$i?>]" value="<?=round(($obj->values), 0)?>">
                </div></th>
