	...
	class Bulletin_EN {
		...
		public function Create() {
			...
			*/
			...
			$this->pdf->SetFont('AngsanaNew', '', 18);
			$txt_8 = $this->pdf->conv("         The earthquake's center was at lattitude  ".round($this->eq_latitude, 2)."   north,  longitude   ".round($this->eq_longitude, 2)."  east. ");
			$this->pdf->MultiCell(0, 7, $txt_8, 0, 'J');
			$this->pdf->Ln(5);
			...
			$txt_12 = $this->pdf->conv("          This Tsunami may have been destructive along coastlines of ".$s1."
             ...
             -  Prepare for  appropaiate disaster relief plan in responsible area
