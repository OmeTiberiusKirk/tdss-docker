  ...
  <DIV id=middle_column>
    <DIV class="section bordered">
      ...
      <DIV class=tutorials_list><!-- InstanceBeginEditable name="visualization_output" -->
        <div style="background-color:#D5EBFD; padding:4px 4px 4px 4px; border-top:#999999 1px solid"><strong>Related operations&nbsp;:&nbsp;</strong><a href="result.php?section=3"><font color="#000099">Create new </font></a> | <a href="bulletin_release.php?section=<?=$_REQUEST['section']?>"><font color="#000099">List of released bulletin</font></a> | <a href="<?=$_SERVER['PHP_SELF']?>?section=<?=$_REQUEST['section']?>"><font color="#000099">Reload</font></a></div>
        <table width="10" height="2" border="0">
          <tr>
            <td></td>
          </tr>
        </table>
        <form action="bulletine_create_script.php" method="post">
          ...
          <table width="10" height="2" border="0">
          ...
          </table><table width="443" border="0" cellpadding="4" cellspacing="0" id="search_tbl" style="display:" class="tbl_border">
            <tr bgcolor="#FFFFFF">
              <td colspan="3" valign="top" bordercolor="#999999" bgcolor="#7B869A"><div align="center" class="style31"> 
            ...
            <tr onMouseOver="javascript: this.style.background='#D0EFFB';" onMouseOut="javascript: this.style.background='';">
              ...
              <th align="left" valign="top" scope="col"><table width="0" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><input name="eq_area" id="eq_area" style="text-align:center" value="(enter earthquake area)"  size="50" maxlength="50"></td>
                  <td></td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
            ...
            <tr onMouseOver="javascript: this.style.background='#D0EFFB';" onMouseOut="javascript: this.style.background='';">
              ...
              <th scope="col" valign="middle"><img src="../../image/buttonorange.gif" alt="0" width="7" height="10"></th>
              <th align="left" valign="top" scope="col"><input name="eq_distance" id="eq_distance" style="text-align:center" value="(enter the distance from coast of thailand)"  size="50" maxlength="50"></th>
            </tr>
            <tr onMouseOver="javascript: this.style.background='#D0EFFB';" onMouseOut="javascript: this.style.background='';">
              <th align="left" valign="middle" bgcolor="#F0F0F0" scope="col">Coast name</th>
              <th scope="col" valign="middle"><img src="../../image/buttonorange.gif" alt="0" width="7" height="10"></th>
              <th align="left" valign="top" scope="col"><input name="eq_coastname" id="eq_coastname" style="text-align:center" value="(name of thailand's coast)"  size="50" maxlength="50"></th>
            </tr>
          </table>
          <table width="10" height="2" border="0">
            <tr>
          ...
          <table border="0" cellpadding="4" cellspacing="0" id="search_tbl2" style="display:" class="tbl_border">
            ...
            <tr onMouseOver="javascript: this.style.background='#D0EFFB';" onMouseOut="javascript: this.style.background='';">
              ...
              <th align="left" valign="middle" bgcolor="" scope="col" class="tbl_border_right">
              <div align="left"><?=$obj->province_t?><input type="hidden" name="ob[province][<?=$i?>]" value="<?=$obj->province_t?>"></div></th>
              <th scope="col" valign="middle" class="tbl_border_right"><div align="left"><?=$obj->name_t?><input type="hidden" name="ob[area][<?=$i?>]" value="<?=$obj->name_t?>"></div></th>
              <th scope="col" valign="middle"><img src="../../image/buttonorange.gif" alt="0" width="7" height="10"></th>
			  ...
			  <?php $res_time = round(($obj->values/3600), 3);
					...
					echo $result_time;
			  ?>
              <input type="hidden" name="ob[eta][<?=$i?>]" value="<?=round(($obj->values/3600), 3)?>"></div></th>
			   <th align="left" scope="col"><div align="center"><?=number_format($val_zmax[$i-1], 2)?><input type="hidden" name="ob[zmax][<?=$i?>]" value="<?=$val_zmax[$i-1]?>"></div></th>
            </tr>
            <?php
			}
            ?>
