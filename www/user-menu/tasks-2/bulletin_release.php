    ...
    <DIV class="section bordered">
      ...
      <DIV class=tutorials_list><!-- InstanceBeginEditable name="visualization_output" -->
        <div style="background-color:#D5EBFD; padding:4px 4px 4px 4px; border-top:#999999 1px solid"><strong>Operations&nbsp;:&nbsp;</strong><font color="#000099"> Select group </font><select name="grp" id="grp" onChange="jump(this.value)" style="font-size:13px; text-align:left">
		  ...
		  ?>
          </select> | <a href="javascript: void(0)" onClick="javascript: alert('! Create bulletin from simulation results\'s page.'); document.location.href='result.php?section=3';"><font color="#000099">Create new </font></a> | <a href="bulletin_release.php?section=<?=$_REQUEST['section']?>"><font color="#000099">List of released bulletin</font></a> | <a href="<?=$_SERVER['PHP_SELF']?>?section=<?=$_REQUEST['section']?>"><font color="#000099">Reload</font></a></div>
        ...
        <?php 
									...
									$point = array();
									$sq = "SELECT * FROM `bulletin`, `sim_result` WHERE `bulletin`.`uid`=".$_SESSION['uid']." AND `bulletin`.`grp_id` = ".$_REQUEST['grp_id']." AND `bulletin`.`from_result_id` = `sim_result`.`id`";
									$res = mysql_query($sq, $connection);
									$no = mysql_num_rows($res);
		?>
        <div id="search_result_box"style="background-color:#FFFFCC; padding:4px 4px 4px 4px; border-top:#999999 1px solid"> <strong> Bulletin history
