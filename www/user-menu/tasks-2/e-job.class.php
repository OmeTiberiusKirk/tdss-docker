					...
					*/
					...
					foreach($p3 as $vis_type => $rc) {
						...
						foreach($rc as $reg_no_t => $file_info) {
							...
							$cn = new BuildVisualizationNetwork($type, "(none)", $region_no, "3D", $DX_region_filename, $DX_waterlevel_filename);
							...
							$cn->BuildNetwork($zoom_ratio, $resolution, 180, 0, 0, $contour_line, $contour_line2, $vis_type, $region_no);
