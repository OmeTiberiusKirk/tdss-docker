...
<DIV id=main>
  ...
  <DIV class="section bordered">
     <H2 id=icon_pick><img src="../../image/color_theory_small_icon.jpg" width="14" height="14">Simulation&nbsp;Name: <?=$_SESSION['vis_name']?>&nbsp;</H2>
                ...
                <table id="HTABS" class="pref_tabs" border="0" cellpadding="0" cellspacing="0">
                  <tbody>
                    <tr>
                      ...
                      <td id="HTAB_3" class="tab_selected"><a href="z_max.php?id=<?=$_REQUEST['id']?>&job_profile_id=<?=$_REQUEST['job_profile_id']?>&grp_id=<?=$_REQUEST['grp_id']?>"><nobr>Wave Height</nobr></a></td>
                              ...
                              <tr>
								...
								?>
                                    <form method="get" name="load_region" id="load_region">
                                      <select name="select" id="select_type" onChange="javascript: window.location='<?=$_SERVER['PHP_SELF']."?r="?>'+this.value+'&id=<?=$_REQUEST['id']?>&job_profile_id=<?=$_REQUEST['job_profile_id']?>&grp_id=<?=$_REQUEST['grp_id']?>';">
                          ...
                          <td><table border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                ...
                                <td valign="top"><fieldset style="background-image:url(../../image/gradient-inner.png); background-repeat:repeat-x; background-color:white">
                                  <legend><span class="style37">Wave height of each points</span></legend>
                              <table border="1" cellpadding="5" cellspacing="0" class=" fs14px">
                                    <tr bgcolor="#FFFFCC" align="center" >
                                      ...
                                      <td><span class="style25"><strong>M</strong></span></td>
                                    </tr>
                                                                            <?php
										$i = 1;
										foreach($_SESSION['point_zmax'] as $id => $elem) {
                                        ?>
                                        <tr align="center" onMouseOver="javascript: this.style.background='#D0EFFB';" onMouseOut="javascript: this.style.background='';">
                                          ...
                                          <td ><?=number_format($elem['value_zmax'], 3)?></td>
                                        </tr>
                                        <?php
                                        }
										?>
