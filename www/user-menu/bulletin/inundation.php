<?php
	...
	$depth_img = $_SESSION['file_root_path']."DEPTH-3D-R4.jpg";
	$colorbar_img = $_SESSION['file_root_path']."DEPTH-COLORBAR-3D-R4.jpg";
?>
  ...
  <DIV class="section bordered">
    ...
    <DIV class=tutorials_list>
      <table class="pref_all" border="0" style="border:#30BFD6 1px solid">
                ...
                <table id="HTABS" class="pref_tabs" border="0" cellpadding="0" cellspacing="0">
                  <tbody>
                    <tr>
                      ...
                      <td id="HTAB_5" class="tab_selected"><a href="inundation.php"><nobr>Inundation Depth</nobr></a></td>
        ...
        <tr>
                        <td class="ForeCode"><table style="display: ;" id="TAB_3" class="prefgroup" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td><table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                          ...
                                          <legend><span class="style37">Image </span></legend>
                                            <table border="0" cellspacing="0" cellpadding="0">
                                              ...
                                              <tr>
                                                ...
                                                <td bgcolor="#000000"><img src="<?=$depth_img?>" alt="0" name="slide" border="0" id="slide"></td>
                                      ...
                                      <td valign="top"><fieldset>
                                        <legend><span class="style37">Info.</span></legend>Level of water depth on the coastline (m.). 
                                        </fieldset></td>
                                    </tr>
                                  </table></td>
                                </tr>
