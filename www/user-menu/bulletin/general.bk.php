<?php
	...
	while($obj_eta = mysql_fetch_object($res_point)) {
		$points[$obj_eta->observ_point_id]['name'] = $obj_eta->name;
	...
	while($obj_zmax = mysql_fetch_object($res_point)) {
		$points[$obj_zmax->observ_point_id]['name'] = $obj_zmax->name;
                            ...
                            <tr>
							  ...
							  <table border="0" cellpadding="3" cellspacing="0">
                                  <tr>
                                    ...
                                    <td><input name="name" type="text" style="width:482px" value="<?=$obj_sim_result->name?>"></td>
                                  </tr>
                                  <tr>
                                    <td valign="top"><strong>Description</strong></td>
                                    <td valign="top"><img src="../../image/buttonorange.gif" alt="0" width="7" height="10"></td>
                                    <td><textarea name="description" cols="30" rows="5" ><?=strlen($obj_sim_result->desc) > 0 ? $obj_sim_result->desc : "(no description)"?></textarea></td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td><img src="../../image/buttonorange.gif" alt="0" width="7" height="10"></td>
                                    <td><input name="domain" type="text" style="width:482px" value="<?=$obj_sim_result->magnitude?>"></td>
                                  </tr>
                                  <tr>
                                    <td valign="middle"><strong>Depth</strong></td>
                                    <td><img src="../../image/buttonorange.gif" alt="0" width="7" height="10"></td>
                                    <td><input name="source" type="text" style="width:482px" value="<?=$obj_sim_result->depth?>"></td>
                                  </tr>
                                  <tr>
                                    <td valign="top"><strong>Location</strong></td>
                                    <td valign="top"><img src="../../image/buttonorange.gif" alt="0" width="7" height="10"></td>
                                    <td><input name="source2" type="text" style="width:482px" value="Latitude = <?=$obj_sim_result->decimal_lat?>, Longitude = <?=$obj_sim_result->decimal_long?>"></td>
                                  </tr>
                                  <tr>
                                    <td colspan="3" valign="middle"><div align="center"><span style="padding:3px">
                                        <INPUT name="dischard" type=reset class=butenter  style="PADDING-RIGHT: 0px; PADDING-LEFT: 0px; PADDING-BOTTOM: 2px; COLOR: #ffffff; PADDING-TOP: 1px; height:27px" onMouseOver="javascript:this.style.background='#ffffff'; this.style.color='#025778';" onMouseOut="javascript:this.style.background='#085D7E';this.style.color='white';  " value="  Discard Change  " disabled>
                                        &nbsp;&nbsp;
                                        <INPUT name="submit" type=submit class=butenter  style="PADDING-RIGHT: 0px; PADDING-LEFT: 0px; PADDING-BOTTOM: 2px; COLOR: #ffffff; PADDING-TOP: 1px; height:27px" onMouseOver="javascript:this.style.background='#ffffff'; this.style.color='#025778';" onMouseOut="javascript:this.style.background='#085D7E';this.style.color='white';  " value="  Submit Change  "  disabled>&nbsp;&nbsp;
                                        <INPUT name="create_bulletin" type=button class=butenter id="create_bulletin"  style="PADDING-RIGHT: 0px; PADDING-LEFT: 0px; PADDING-BOTTOM: 2px; COLOR: #ffffff; PADDING-TOP: 1px; height:27px" onMouseOver="javascript:this.style.background='#ffffff'; this.style.color='#025778';" onMouseOut="javascript:this.style.background='#085D7E';this.style.color='white';  " value="Create bulletin" onClick="javascript: location.href='../tasks/bulletin.php?section=4.1&id=<?=$_REQUEST['id']?>&grp_id=<?=$_REQUEST['grp_id']?>&grp_id=<?=$_REQUEST['grp_id']?>';">
                                        </span></div></td>
                                  </tr>
                                </table>
								</form>
