...
while ($obj_eta = mysql_fetch_object($res_point)) {
    $points[$obj_eta->observ_point_id]['province'] = $obj_eta->province_t;
...
<HEAD>
  ...
  <SCRIPT src="../../script/mainscript.js" type=text/javascript> </SCRIPT> <style>
    .black_overlay {
	display: none;
	position:fixed;
	top: 0%;
...
<BODY>
  ...
  <DIV id=main>
    ...
    <DIV class="section bordered">
      <H2 id=icon_pick><img src="../../image/color_theory_small_icon.jpg" width="14" height="14">Reference ID: <font
          color="#FFFFCC">
...
echo $obj_sim_result->name;?>
      ...
      <DIV class=tutorials_list2>
        <div style="border-top:#FF9900 1px solid;background-color:#FFFFCC; padding:4px 4px 4px 4px"><strong>Operations
            : </strong><a href="../tasks/search.php?section=4">Home</a></div>
      </DIV>
            ...
            <tr>
              <td colspan="2">
                ...
                <table id="HTABS" class="pref_tabs" border="0" cellpadding="0" cellspacing="0">
                  <tbody>
                    <tr>
                      <td id="HTAB_0" class="tab_selected"><a href="general.php?id=<?=$_REQUEST['id']?>&job_profile_id=<?=$_REQUEST['job_profile_id']?>&grp_id=<?=$_REQUEST['grp_id']?>">
                          <nobr>General</nobr>
                        </a></td>
                      <td id="HTAB_2" class="tab q"><a href="eta.php?id=<?=$_REQUEST['id']?>&job_profile_id=<?=$_REQUEST['job_profile_id']?>&grp_id=<?=$_REQUEST['grp_id']?>">
                          <nobr>Elapsed Time</nobr>
                        </a></td>
                      <td id="HTAB_3" class="tab q"><a href="z_max.php?id=<?=$_REQUEST['id']?>&job_profile_id=<?=$_REQUEST['job_profile_id']?>&grp_id=<?=$_REQUEST['grp_id']?>">
                          <nobr>Tsunami Amplitude</nobr>
                        </a></td>
                ...
                <table class="pref_content">
                  <tr>
                    <td class="ForeCode">
                      <table style="" id="TAB_0" class="prefgroup" cellpadding="0" cellspacing="0">
                        <tr>
                          <td>
                                    ...
                                    <form action="../../library/update-expr.php" method="post" name="expr">
                                      <table border="0" cellpadding="6" cellspacing="0">
                                        <!-- <tr>
                                          ...
                                          <td valign="top"><img src="../../image/buttonorange.gif" alt="0" width="7"
                                              height="10"></td>
                                          <td>
<?php
...
?>
                                ...
                                <td valign="top">
                                  <fieldset style="background-image:url(../../image/gradient-inner.png); background-repeat:repeat-x; background-color:#FFFFFF">
                                    ...
                                    <table border="0" cellpadding="5" cellspacing="3" class=" tbl_border fs14px" id="tbl01"
                                      style="display:">
                                      <tr align="center" bgcolor="#FFFFCC" class="td-0">
                                        ...
                                        <td class="tbl_border_right" onClick="javascript: change_time();"><strong>Elapsed
                                            Time (h:m)</strong></td>
                                        <td class=""><strong>Tsunami&nbsp;Amplitude&nbsp;(m)</strong></td>
                                      </tr>
                                      <?php

$order = array_merge(range(2, 6), [1], range(7, 16), range(19, 21), [22, 24, 17, 18, 23], range(25, count($points)));

$i = 1;
foreach ($order as $id) {
    ?>
                                      <tr align="center" onMouseOver="javascript: this.style.background='#D0EFFB';"
                                        onMouseOut="javascript: this.style.background='';">
                                        <td class="tbl_border_top tbl_border_right">
                                          <div align="left">
                                            <?=$i++ . ") " . $points[$id]['name'] . ", " . $points[$id]['province']?>
                                          </div>
                                        </td>
                                        <td class="tbl_border_top tbl_border_right">
                                          <div align="right">
...
?>
                                    ...
                                    <table border="0" cellpadding="5" cellspacing="3" class=" tbl_border fs14px" id="tbl02"
                                      style="display:none">
                                      <tr align="center" bgcolor="#FFFFCC" class="td-0">
                                        <td class="tbl_border_right"><strong>Name</strong></td>
                                        <td class="tbl_border_right"><strong>Latitude</strong></td>
