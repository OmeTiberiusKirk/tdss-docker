<?php
	...
	switch($_REQUEST['r']) {
		case 1:
		default:
			$uvm_img = $_SESSION['file_root_path']."UVM-3D-R1.jpg";
			$colorbar_img = $_SESSION['file_root_path']."UVM-3D-R1-COLORBAR.jpg";
			$_REQUEST['r'] = 1;
			break;
		case 2:
			$uvm_img = $_SESSION['file_root_path']."UVM-3D-R2.jpg";
			$colorbar_img = $_SESSION['file_root_path']."UVM-3D-R2-COLORBAR.jpg";
			break;
		case 3:
			$uvm_img = $_SESSION['file_root_path']."UVM-3D-R3.jpg";
			$colorbar_img = $_SESSION['file_root_path']."UVM-3D-R3-COLORBAR.jpg";
			break;
		case 4:
			$uvm_img = $_SESSION['file_root_path']."UVM-3D-R4.jpg";
			$colorbar_img = $_SESSION['file_root_path']."UVM-3D-R4-COLORBAR.jpg";
			break;
	}
                ...
                <table id="HTABS" class="pref_tabs" border="0" cellpadding="0" cellspacing="0">
                  <tbody>
                    <tr>
                      ...
                      <td id="HTAB_6" class="tab_selected"><a href="velocity.php"><nobr>Velocity</nobr></a></td>
                              ...
                              <tr>
								...
								?>
                                    <form method="get" name="load_region" id="load_region">
                                      <select name="select" id="select_type" onChange="javascript: window.location='<?=$_SERVER['PHP_SELF']."?r="?>'+this.value;">
                          ...
                          <td><table border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                      ...
                                      <table border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                          <td valign="top" bgcolor="#000000"><table border="0" cellspacing="0" cellpadding="0">
                                              ...
                                              <tr>
                                                <td><img src="../../image/space_black.jpg" alt="0" width="17" height="50"></td>
                                                <td><img src="<?=$colorbar_img?>" alt="0"></td>
                                                <td>&nbsp;</td>
                                              </tr>
                                          </table></td>
                                          <td bgcolor="#000000"><img src="<?=$uvm_img?>" alt="0" name="slide" border="0" id="slide"></td>
								...
								<td valign="top"><!--<fieldset>
                                      <legend><span class="style40">Changing Colorbar Value </span></legend>
                                      <table border="1" cellpadding="5" cellspacing="0" class=" fs14px">
                                        <tr align="center">
                                          <td bgcolor="#B1C3D9" align="center"><span class="style42 style25"><strong>velocity (max) </strong></span></td>
                                          <td >
										...
										<tr align="center">
                                          <td colspan="2"><input name="Add" type="button" value="Edit"></td>
                                        </tr>
                                      </table>
                                    </fieldset>--></td>
                                <td valign="top"><fieldset>
                                  <legend><span class="style37">Velocity of each point </span></legend>
                                  <table border="1" cellpadding="5" cellspacing="0" class=" fs14px">
                                    <tr bgcolor="#FFFFCC" align="center" >
                                      <td><span class="style25"><strong>Name</strong></span></td>
                                      <td><span class="style25"><strong> (m/s) </strong></span></td>
                                    </tr>
                                    <tr align="center">
                                      <td><div align="left">Phuket</div></td>
                                      <td >180</td>
                                    </tr>
                                    <tr align="center">
                                      <td><div align="left">Ranong</div></td>
                                      <td >210</td>
                                    </tr>
                                    <tr align="center">
                                      <td><div align="left">Trung</div></td>
                                      <td >190</td>
                                    </tr>
                                  </table>
                                </fieldset></td>
