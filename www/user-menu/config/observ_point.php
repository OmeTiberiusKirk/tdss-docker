...
<script language="javascript">
	...
	function enable_map(lat, long, info) {
		document.getElementById('light').style.display = 'block';
		document.getElementById('fade').style.display = 'block'
		document.getElementById('res').src = 'http://www.ndwc.go.th/server_monitoring/map.php?lat='+lat+'&long='+long+'&zoom=9&info='+info;
	}
        ...
        <form action="point_update.php?grp_id=<?=$now_id?>" method="post">                
                      ...
                      <div align="left">
                        ...
                        <?php 
                          ...
                          <td colspan="9" class="tbl_border_top">(no observation point)</td>
                          </tr>
                                    <?php
									}else{
										for($i=0; $i<$no; $i++)
